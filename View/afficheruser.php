...
<td>
    ...
    if ($roletitre !== 'admin') {
        // Provide a link to upgrade the user to admin
        echo '<a href="add_admin.php?user_id=' . $row['id'] . '" style="background-color: green; color: white; padding: 5px; text-decoration: none;">Make Admin</a>';
    }
    ?>
</td>
</tr>
