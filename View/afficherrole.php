...
<a href="ajouterrole.php" style="background-color: #f44336; color: white; padding: 8px 12px; border-radius: 3px;">Ajouter role</a>
<br><br>
    ...
    <table class="role-table">
        ...
        <tbody>
            <?php foreach ($role as $role_item): ?>
                <tr>
                    <td><?php echo $role_item['titre']; ?></td>
                    <td>
                        <a class="delete-btn" href="supprimerrole.php?idrole=<?php echo $role_item['idrole']; ?>">Delete</a>
                        <a class="edit-btn" href="modifierrole.php?idrole=<?php echo $role_item['idrole']; ?>">Edit</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
