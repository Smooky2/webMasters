...
<br>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>
                    Rue Slimane El Hrairi, LAC 1</p>
                <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>artme@gmail.com</p>
                <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+216 50 819 687 </p>
            </div>
            <div class="col-lg-3 col-md-6">
    ...
    <div class="container-fluid bg-dark text-secondary text-center border-top py-4 px-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <p class="m-0">&copy; <a class="text-secondary border-bottom" href="#">Art Me</a>. All Rights Reserved. Designed by <a class="text-secondary border-bottom" href="https://htmlcodex.com">Goal Diggers</a></p>
    </div>
    <!-- Footer End -->
