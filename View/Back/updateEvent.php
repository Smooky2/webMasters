...
<div class="content">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="idE" name="idE" class="form-control" value="<?php echo $event['idE']; ?>" >
    </div>
    <div class="mb-3">
        <label for="nomE" class="form-label">Nom:</label>
        <input type="text" id="nomE" name="nomE" class="form-control" value="<?php echo $event['nomE']; ?>" >
    </div>
    <div class="mb-3">
        <label for="dateE" class="form-label">Date:</label>
        <input type="date" id="dateE" name="dateE" class="form-control" value="<?php echo $event['dateE']; ?>" >
    </div>
    <div class="mb-3">
        <label for="heureE" class="form-label">Time:</label>
        <input type="time" id="heureE" name="heureE" class="form-control" value="<?php echo $event['heureE']; ?>" >
    </div>
    <div class="mb-3">
        <label for="lieuE" class="form-label">Lieu:</label>
        <input type="text" id="lieuE" name="lieuE" class="form-control" value="<?php echo $event['lieuE']; ?>" >
    </div>
    <div class="mb-3">
        <label for="descrpE" class="form-label">Description:</label>
        <textarea id="descrpE" name="descrpE" class="form-control" ><?php echo $event['descrpE']; ?></textarea>
    </div>
    <div class="mb-3">
        <label for="categoE" class="form-label">Catégorie:</label>
        <select id="categoE" name="categoE" class="form-select" >
            <option value="" disabled selected>Choisissez une catégorie</option>
            <option value="Environnemental et écologique" <?php if ($event['categoE'] == "Environnemental et écologique") echo "selected"; ?>>Environnemental et écologique</option>
            <option value="Culturel" <?php if ($event['categoE'] == "Culturel") echo "selected"; ?>>Culturel</option>
            <option value="Sportif" <?php if ($event['categoE'] == "Sportif") echo "selected"; ?>>Sportif</option>
            <option value="Récréatif et divertissant" <?php if ($event['categoE'] == "Récréatif et divertissant") echo "selected"; ?>>Récréatif et divertissant</option>
            <option value="Éducatif" <?php if ($event['categoE'] == "Éducatif") echo "selected"; ?>>Éducatif</option>
        </select>
    </div>
    <div class="mb-3">
        <label for="fraisE" class="form-label">Frais:</label>
        <input type="text" id="fraisE" name="fraisE" class="form-control" value="<?php echo $event['fraisE']; ?>">
    </div>
    <!-- Submit Button -->
