                    ...
                    <tbody>
                        ...
                        <?php foreach ($list as $event)  
                        {
                            ...
                            <tr>
                                ...
                                <td><?= $event['fraisE']; ?></td>
                                <td>
                                    <form method="POST" action="../Back/updateEvent.php">
                                ...
                                <td><a href="../Back/list_rate.php?id=<?= $event['idE']; ?>" class="btn btn-danger btn-sm">review</a>
...
<div class="text-center">
    <form method="POST" action="../Back/searchReview.php">
