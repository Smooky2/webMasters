    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="forum.php" class="dropdown-item">rechercher </a>
                        </div>
                    </div>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Add event page</h1>
                        <h1 class="page-subhead-line">Only the admin has the right to add an event </h1>

                    </div>
                   

                    <form role="form" action="addhotel.php" method="post" enctype="multipart/form-data">
                       ...
                       <div>
                        ...
                        <div >
                            ...
                            <input class="form-control" type="location" id="location", name="location">
                            <p class="help-block">Help text here.</p>
                        </div>
                        <div >
                         ...
                         <div>
                        <label> image </label>
                            <textarea class="form-control" rows="3" id="images", name="images"></textarea>
                            <p class="help-block">Help text here.</p>
                         </div>
                        ...
                        <input type="submit" name="submit" value="Add the hotel" class="btn btn-info" onclick="return validateForm()">
        ...
        if (name.length > 10) {
            alert("Le nom ne doit pas dépasser 10 caractères !");
            return false;
        }
