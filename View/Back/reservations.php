...
<body>
    ...
    <div id="page-inner">
        ...
        /*require '../../Model/participant_class.php';
        require '../../Contoller/participant1_class.php';*/
    ...
    <div class="col-md-12">
                    ...
                    <tbody>
                        <?php foreach ($resList as $res) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="updatereservation.php?id=<?php echo $res['id']; ?>" class="btn btn-warning">Update</a>
                                    <a href="deletereservation.php?id=<?php echo $res['id']; ?>" class="btn btn-danger">Delete</a>
                                    <a href="trireservation.php" class="btn btn-danger">Trier</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        textarea:focus {
            border: 1px solid #4caf50;
                ...
                <body>
                    <form action="testReservation.php" method="post">
