...
require '../../Contoller/res1_class.php';
 // Créer une instance de la classe reservations
    $res = new reservations();
    
    // Appeler la méthode triRes() avec l'ID de la réservation
    $resList = $res->triRes();
...
<body>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="forfait.php" class="dropdown-item">Nos forfaits</a>
                            <a href="table.php" class="dropdown-item">Nos réservations </a>
                        </div>
                    </div>
                    <a href="forum.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>entité_forum</a>
    ...
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">reservation table</h1>
                <h1 class="page-subhead-line">Only the admin can delete or update the reservation</h1>
            </div>
            ...
            <tbody>
                <?php foreach ($resList as $res) : ?>
                    <tr>
                        ...
                        <td><?php echo $res['idH']; ?></td>
                        <td><?php echo $res['my_image'];?></td>
                        <td>
                            <a href="update.php?id=<?php echo $res['id']; ?>" class="btn btn-warning">Update</a>
                            <a href="delete.php?id=<?php echo $res['id']; ?>" class="btn btn-danger">Delete</a>
                            <a href="tri.php" class="btn btn-danger">Trier</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
