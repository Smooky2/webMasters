...
<body>
    ...
    <!-- Déplacez le formulaire ici -->
    <table style="width: 100%; border-collapse: collapse; border-spacing: 0;">
  <thead>
    <tr>
    <th style="padding: 10px; border-bottom: 1px solid #ddd; background-color: #f2f2f2; text-align: left;">ID</th>  
      <th style="padding: 10px; border-bottom: 1px solid #ddd; background-color: #f2f2f2; text-align: left;">Titre</th>
      <th style="padding: 10px; border-bottom: 1px solid #ddd; background-color: #f2f2f2; text-align: left;">Description</th>
      <th style="padding: 10px; border-bottom: 1px solid #ddd; background-color: #f2f2f2; text-align: left;">Date de création</th>
      <th style="padding: 10px; border-bottom: 1px solid #ddd; background-color: #f2f2f2; text-align: left;">id_user</th>
      <th style="padding: 10px; border-bottom: 1px solid #ddd; background-color: #f2f2f2; text-align: left;"></th>
    </tr>
  </thead>
  <tbody>
    <?php foreach ($forumList as $forum):?>
      <tr style="background-color: #f2f2f2;">
      <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $forum['id_forum'];?></td>
        <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $forum['titre'];?></td>
        <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $forum['description'];?></td>
        <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $forum['date_creation'];?></td>
        <td style="padding: 10px; border-bottom: 1px solid #ddd;"><?php echo $forum['createur_forum_id'];?></td>
