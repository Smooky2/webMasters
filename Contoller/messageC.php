...
include 'C:\xampp\htdocs\projetfinal\vendor\autoload.php';
...
public function addComment($forum_id, $comment_content,$date_sys,$id_user)
    {
...
public function deleteCommentforum($id_forum)
{
    $sql = "DELETE  FROM message WHERE id_forum = :id_forum";
    $db = Config::getConnexion();
